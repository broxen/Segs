...
public:
        ...
        int                 m_update_idx                = 0;
        bool                m_pchar_things              = false; // to be replaced by m_client_update_flags
        bool                m_update_appearance         = false; // to be replaced by m_client_update_flags
        ...
        uint32_t            m_client_update_flags       = 0;
